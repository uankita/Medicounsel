...
$query="select * from tbl_doc order by doc_id ";
...
<body>
<center style=color:white;><h1>***DISPLAY***</h1></center>
...
<td><a href="doc_edit.php?doc_id=<?php echo $row['doc_id'];?>">edit</a></td>
<td><a href="doc_delete.php?doc_id=<?php echo $row['doc_id'];?>">delete</a></td>
</tr>
<?php
$a++;
}
