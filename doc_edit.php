...
?>
<center><form action="doc_update.php" method="POSt">
<?php
if($row=mysql_fetch_array($res,MYSQL_BOTH))
{
	?>
	<h1 style=color:white;>***UPDATE DOCTOR PROFILE***</h1>
NAME: <input type="text" name="name" value="<?php echo $row['name'];?>"/ ><br><br>
F'NAME: <input type="text" name="fname" value="<?php echo $row['fname'];?>"/ ><br><br>
...
<option>cancer specialist<option>
</select><br/><br/>
FESS: <input type="text" name="fees"/><br/><br/>
TIMING: <input type="time" name="timing"/><br/><br/>
