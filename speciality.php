...
$query="select distinct speciality from tbl_doc";
...
<br/><br/><center style=color:white;><h1>***BOOK A DOCTOR FOR APPOINTMENT***</h1></center><br/><br/>
<center><select name="speciality">
